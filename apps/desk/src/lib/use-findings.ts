 ...
 * prose once and runs seventeen detectors over it. Warm, when there were
 * sixteen, it cost a median of 1.1ms over `examples/vault/personal-readme.md`
 * (1,920 words) and 3.2ms over three copies of it (5,760 words), measured
 * across 60 iterations. That is
 ...
 * scanned seventeen times, which does not change that.
 *
