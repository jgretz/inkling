...
mod tests {
    ...
    fn should_create_the_data_directory_when_the_vault_has_none() {
        ...
        assert_eq!(status, VaultDbStatus::Ready { schema_version: 5 });
    ...
    fn should_keep_existing_rows_when_the_same_vault_is_opened_again() {
        ...
        assert_eq!(first, VaultDbStatus::Ready { schema_version: 5 });
        assert_eq!(second, VaultDbStatus::Ready { schema_version: 5 });
